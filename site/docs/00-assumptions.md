...
| A2  | Le site Down Trigger (downtrigger.fr) a été réalisé par Nicolas Jez (création directe)         | moyenne   | la page projet doit être retirée ou requalifiée | **à confirmer**         |
...
| A7  | Un domaine de production n'est pas encore défini ; l'URL finale reste configurable             | élevée    | rien                                            | acceptée                |
...
- D4 : tout projet sans droits confirmés démarre en `draft` et est exclu du sitemap.
