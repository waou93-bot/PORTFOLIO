...
| Champ               | Valeur                                                                                                        |
| ------------------- | ------------------------------------------------------------------------------------------------------------- |
| Projet              | Portfolio professionnel premium — "Nicolas Jez — Selected Works"                                              |
| Propriétaire        | Nicolas Jez (France)                                                                                          |
| Positionnement      | "Je conçois des expériences web qui ne ressemblent pas à des templates."                                      |
| Sous-positionnement | Direction artistique, UX/UI, landing pages immersives, développement front-end et motion design.              |
| Livrable            | Portfolio complet : identité, accueil, projets, études de cas, formulaire, mentions légales, confidentialité. |
| Contrainte clé      | Le portfolio lui-même doit prouver la maîtrise : performance, accessibilité, SEO, animation, responsive.      |

## Objectifs (ordre de priorité)

1. Impression de qualité et de maîtrise en < 5 s.
2. Compréhension des types de projets et du niveau de finition en < 30 s.
