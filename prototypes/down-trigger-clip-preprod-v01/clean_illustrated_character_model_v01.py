...
SOURCE = ROOT / "assets" / "derived-down-trigger" / "down-trigger-masked-character-illustrated-model-provisional-v01.png"
TARGET = ROOT / "assets" / "derived-down-trigger" / "down-trigger-masked-character-illustrated-model-provisional-v01-clean.png"
...
def main():
    ...
    # Keep the dark/blue/rust illustrated character and discard the uniform
    # bone-paper field. Connectivity removes isolated paper flecks.
    candidate = (luma < 176) | (chroma > 38)
    h, w = candidate.shape
