...
gif = Image.open(ROOT / "hand-release-registered-v05.gif")
frames = []
index = 0
while True:
...
sheet.save(ROOT / "hand-release-registered-v05-detail-sheet.png")
print(f"Wrote {ROOT / 'hand-release-registered-v05-detail-sheet.png'} ({len(frames)} frames)")
