...
base.OUTPUT = ROOT / "hand-release-registered-v07.gif"


def clean_plate(image: Image.Image, _removal_mask: Image.Image):
    """Use an interior slab sample, avoiding both the slab edge and symbol."""
    width, height = image.size
    ground = base.tiled_texture(image, (0, 0, 260, 145), image.size)
    source_rows = base.crop_rows(Image.open(base.SOURCE))
    slab = base.tiled_texture(source_rows[2], (805, 155, 925, 275), image.size)
